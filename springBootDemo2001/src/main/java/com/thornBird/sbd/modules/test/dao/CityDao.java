...
public interface CityDao {
	...
	City getCityByCityNameAndLocalCityName(@Param("cityName") String cityName,
			@Param("localCityName") String localCityName);
	...
	@Select("<script>" +
		...
		+ "limit 1"
		+ "</script>")
	City getCityByCityNameAndLocalCityName1(@Param("cityName") String cityName,@Param("localCityName") String localCityName);
